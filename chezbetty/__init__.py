...
def main(global_config, **settings):
    ...
    config.add_route('admin_events_restock',            '/admin/events/restock')
    config.add_route('admin_events_emptycash',          '/admin/events/emptycash')
    config.add_route('admin_events_deposit',            '/admin/events/deposit')
